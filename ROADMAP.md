...
9. **Eficiência de tokens — eixo §9** — disciplina em queries `qmd` ✓ (2026-05-02), granularizar `convencoes-paginas.md`, fragmentar Revista Espírita por artigo, Haiku para tarefas determinísticas. Custo composto: ganho pequeno por turno, alto somado em meses de uso. Próximo passo natural: granularizar `convencoes-paginas.md` (187 linhas injetadas em CADA Edit em `wiki/**`) — corte permanente em todo turno de edição.
