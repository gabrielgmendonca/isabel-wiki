...
tags: [psicometria, mediunidade, telestesia, clarividencia, desdobramento, andre-luiz, autor/kardec, autor/andre-luiz, autor/chico-xavier, tema/mediunidade, obra/lm, grau/intermediario]
...
> "Faculdade de perceber o lado oculto do ambiente e de ler impressões e lembranças, ao contato de objetos e documentos, nos domínios da sensação a distância." (André Luiz / Chico Xavier, *Mecanismos da Mediunidade*, cap. 20)
...
A função operativa: o psicômetra "desarticula" a força nervosa de núcleos específicos (visão, audição) e a transfere para a onda mental projetada, "possuindo olhos e ouvidos a distância do envoltório denso". O fenômeno é caso particular do [[wiki/conceitos/desdobramento]], em regime parcial e voluntário.
...
A psicometria, como toda mediunidade, é regida pela [[wiki/conceitos/escala-espirita]]: o conjunto **consulente + médium + objeto** atrai Espíritos afins. Consulta com motivação inferior (curiosidade, vingança, ganho) recolhe informação correspondente ou fracassa.
...
1. **Recolhimento e prece como gatilho.** Reflexo condicionado positivo orienta a sintonia para Espíritos elevados.
2. **Não interpretar para impressionar.** Resistir à tentação de exibir acerto: o conjunto vibratório se vicia.
3. **Verificação independente.** O médium não tem certeza absoluta da operação cooperativa; o que percebeu pode ter componente anímico (ver [[wiki/conceitos/animismo]]). Deixar verificar.

### Conduta do consulente

1. **Motivo limpo.** Vingança, curiosidade ou interesse mesquinho atraem Espíritos análogos e produzem informação enganosa.
2. **Não absolutizar a leitura.** Mesmo psicômetra dotado pode receber **fragmentos** da história do objeto, induzidos pela parcela do mundo espiritual que comparece. A psicometria assiste a investigação, não a substitui.
...
- [[wiki/conceitos/onda-mental]] — substrato da extroversão psicométrica
- [[wiki/conceitos/desdobramento]] — psicometria é desdobramento parcial
- [[wiki/conceitos/manifestacoes-espiritas]] — quadro fenomenológico geral (clarividência, clariaudiência, telestesia)
- [[wiki/conceitos/perispirito]] — atmosfera fluídica que impregna objetos
- [[wiki/conceitos/identidade-dos-espiritos]] — exame da fonte das impressões recebidas
- [[wiki/conceitos/animismo]] — componente anímico inerente à operação
- [[wiki/conceitos/escala-espirita]] — sintonia consulente + médium atrai nível correspondente
- [[wiki/obras/livro-dos-mediuns]] — caps. XIV–XVI (sensitivos, videntes, sonâmbulos)
- [[wiki/obras/mecanismos-da-mediunidade]] — cap. 20
...
- XAVIER, Francisco Cândido; VIEIRA, Waldo (André Luiz). *Mecanismos da Mediunidade*. Rio de Janeiro: FEB, 1959. Cap. 20 (Psicometria). Edição: [[raw/mediuns/chico-xavier/andre-luiz/mecanismos-da-mediunidade]].
- XAVIER, Francisco Cândido (André Luiz). *Nos Domínios da Mediunidade*. Rio de Janeiro: FEB, 1955. Cap. 26 (psicometria como espécie da fenomenologia mediúnica). Edição: [[raw/mediuns/chico-xavier/andre-luiz/nos-dominios-da-mediunidade]].
