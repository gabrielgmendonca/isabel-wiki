...
tags: [mandato-mediunico, mediunidade, missao, andre-luiz, autor/andre-luiz, autor/chico-xavier, autor/kardec, obra/lm, grau/avancado, tema/mediunidade, tema/livre-arbitrio]
...
| Categoria | Caso paradigmático | Característica |
|-----------|-------------------|----------------|
| **Mandato mediúnico** | Ambrosina (cap. 16) | mentor fixo, faixa fluídica de enlace, programa pré-encarnatório |
...
| **Mediunidade de provação** | Pedro epiléptico (cap. 9) | passividade obsidente; primeiro saldar a dívida, depois servir |
| **Mediunidade torturante** | médium do tutor envenenado (cap. 10); fascinada da Toscana (cap. 23) | reciprocidade obsidente do passado, simbiose mental com obsessor |
| **Mediunidade transviada** | cap. 27 | médium genuíno desvirtuado pela vaidade ou exploração |
...
- [[wiki/conceitos/mediunidade]] — moldura geral
