...
tipo: conceito
fontes: [LE]
tags: [autodesamor, autoconhecimento, ego-self, autoperdao, joanna-de-angelis, autor/joanna-de-angelis, autor/kardec, obra/le, tema/moral, tema/sofrimento, grau/intermediario, lei/justica-amor-caridade]
...
A questão complementar é **LE, q. 919** (já discutida em [[wiki/conceitos/autoconhecimento]]): o autoconhecimento é o "meio prático mais eficaz" de melhorar — mas pressupõe um sujeito *capaz* de se conhecer com lucidez, sem o filtro distorcido da auto-rejeição.
...
**Mecanismo obsessivo**: *"em razão das emissões de ondas mentais perniciosas, esse paciente atrai espíritos outros, ociosos e zombeteiros, que passam a conviver com as suas energias, dando lugar a obsessões simples, que culminam em estados de subjugação e de vampirização"* — convergente com [[wiki/conceitos/obsessao]] simples (cf. [[wiki/obras/livro-dos-mediuns|LM]] cap. 23) e com [[wiki/conceitos/vampirismo-espiritual]].
...
1. **Autoperdão fundamentado em LE q. 122** — a culpa cede ao reconhecimento da relatividade do estágio evolutivo: *"a compreensão lógica dos mecanismos evolutivos faculta a conquista do autoperdão, de uma visão mais compatível com o seu nível de evolução, permitindo-se a possibilidade de erro, mas também de acerto"*.
2. **Conversações edificantes, leituras estimuladoras, convivências exemplares** — substituição das paisagens mentais depressivas.
3. **Confiança nos recursos da vida** — relacionamentos humanos, projetos de crescimento, serviço comunitário, faculdades transcendentes.
4. **Cultivo do auto-amor como pré-condição do amor ao próximo** (Mt 22:39) — sem o auto-amor, o "amor ao próximo" vira transferência neurótica.
...
- [[wiki/conceitos/obsessao]] — convergência da autopiedade com a obsessão simples.
- [[wiki/conceitos/vampirismo-espiritual]] — atração de espíritos zombeteiros pela autopiedade.
- [[wiki/personalidades/joanna-de-angelis]] — autora da sistematização.
- [[wiki/obras/encontro-com-a-paz-e-a-saude]] — cap. 3, fonte primária da categorização.

## Fontes

- Joanna de Ângelis / Franco, Divaldo Pereira (psicografia). *[[wiki/obras/encontro-com-a-paz-e-a-saude|Encontro com a Paz e a Saúde]]*. Salvador: LEAL, 2007. Cap. 3 — *Autodesamor* (Autocondenação, Autopiedade, Autoconsciência).
