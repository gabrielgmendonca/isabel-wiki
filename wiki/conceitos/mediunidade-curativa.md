---
tipo: conceito
fontes: [LE, LM, ESE, OPE, André Luiz/Chico Xavier]
tags: [mediunidade-curativa, passe, fluidoterapia, magnetismo, fluido-cosmico, perispirito, prece, mediunidade, andre-luiz, autor/kardec, autor/andre-luiz, autor/chico-xavier, tema/mediunidade, tema/prece-caridade, obra/le, obra/lm, obra/ese, obra/ope, grau/intermediario]
...
| Tipo | Operação | Risco principal |
|------|----------|-----------------|
| **Passe magnético comum** | Médium impõe mãos ou aproxima-as do enfermo; transmissão de fluido próprio + cooperação espiritual | Esgotamento do médium quando trabalha sozinho ou sem prece |
| **Passe à distância** | Médium em desdobramento parcial dirige fluido a paciente longe (cf. [[wiki/conceitos/desdobramento]]) | Falta de retorno; verificação dependente de coordenação |
| **Fluidificação de água** | Espíritos imprimem qualidades fluídicas em copo de água, ingerido pelo enfermo (Gênese cap. XIV item 35; ESE cap. XXVIII item 81) | Substituir tratamento médico; fetichizar o copo |
| **Prece intercessória dirigida** | Grupo concentra prece em favor de pessoa nomeada, com ou sem objeto pessoal | Confundir com magia (objeto que "tem poder") |
| **Oração de socorro a obsessor** | Caridade ao Espírito perturbador como caminho indireto de cura do obsidiado (cf. [[wiki/conceitos/obsessao]]) | Esquecer o obsessor sob a forma "tirar o demônio" |
...
- [[wiki/conceitos/passe]] — operação específica (subconjunto da mediunidade curativa)
- [[wiki/conceitos/fluidos]] — hierarquia geral
- [[wiki/conceitos/fluido-cosmico-universal]] — reservatório
- [[wiki/conceitos/perispirito]] — meio de incorporação dos fluidos
- [[wiki/conceitos/onda-mental]] — substrato da sintonia médium-paciente
- [[wiki/conceitos/prece]] — gatilho operativo
- [[wiki/conceitos/centros-vitais]] — anatomia do psicossoma (André Luiz, *Evolução em Dois Mundos*)
- [[wiki/conceitos/mediunidade]] — quadro doutrinário geral
- [[wiki/conceitos/obsessao]] — caridade ao obsessor como cura indireta
- [[wiki/obras/livro-dos-mediuns]] — cap. XIV, item 175 (médiuns curadores)
- [[wiki/obras/genese]] — cap. XIV, itens 31–35
- [[wiki/obras/evangelho-segundo-o-espiritismo]] — caps. XXVII–XXVIII (prece, fluido salutar)
- [[wiki/obras/mecanismos-da-mediunidade]] — cap. 22
...
- XAVIER, Francisco Cândido; VIEIRA, Waldo (André Luiz). *Mecanismos da Mediunidade*. Rio de Janeiro: FEB, 1959. Cap. 22 (Mediunidade curativa). Edição: [[raw/mediuns/chico-xavier/andre-luiz/mecanismos-da-mediunidade]].
- XAVIER, Francisco Cândido (André Luiz). *Missionários da Luz*. Rio de Janeiro: FEB, 1945. Cap. 19 (passes magnéticos, regra dos 10 socorros). Edição: [[raw/mediuns/chico-xavier/andre-luiz/missionarios-da-luz]].
- XAVIER, Francisco Cândido; VIEIRA, Waldo (André Luiz). *Evolução em Dois Mundos*. Rio de Janeiro: FEB, 1958. Anatomia do psicossoma e centros vitais. Edição: [[raw/mediuns/chico-xavier/andre-luiz/evolucao-em-dois-mundos]].
