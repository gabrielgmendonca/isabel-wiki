...
tipo: conceito
fontes: [ESE]
tags: [parabola, jesus, lavradores-maus, responsabilidade, obra/ese, autor/kardec, grau/intermediario, tema/jesus]
...
1. **Quem mais recebe, mais deve.** Os que foram constituídos guias espirituais serão julgados com maior rigor se trairem a confiança (ESE, cap. XVIII, item 10).
2. **Missão não é propriedade.** A vinha pertence ao senhor; os lavradores são arrendatários. Transformar responsabilidade em domínio pessoal — apoderar-se de herança alheia — é a raiz da perversão religiosa que Jesus denuncia aos sacerdotes do templo.
...
- [[wiki/conceitos/parabola-dos-talentos]] — responsabilidade sobre os dons recebidos
