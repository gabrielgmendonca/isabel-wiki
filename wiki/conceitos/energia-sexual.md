...
tags: [energia-sexual, sexo, libido, sublimacao, magnetismo, centro-genesico, no-mundo-maior, freud, jung, adler, lei/reproducao, obra/le, obra/ese, autor/andre-luiz, autor/chico-xavier, autor/emmanuel, autor/kardec, grau/intermediario, tema/moral, lei/justica-amor-caridade]
...
Emmanuel dedica três capítulos diretos ao tema — caps. 5 (Energia sexual), 6 (Compromisso afetivo) e 24 (Carga erótica) — e atravessa o assunto em todos os 25 capítulos da obra ([[wiki/obras/vida-e-sexo]]).
...
O sexo é tratado como **causa primária de loucura** — articulação direta com [[wiki/conceitos/casa-mental]] e [[wiki/conceitos/obsessao]]. Cinco eixos doutrinários acrescentam material à página:
...
- **Origem evolutiva.** O centro genésico evolui do hermafroditismo das plantas à diferenciação sexual dos vertebrados (parte I, caps. 6 e 18) — convergente com Emmanuel ("herdamos espiritualmente de nós mesmos, pelas raízes do renascimento físico", *Vida e Sexo*, cap. 14).
...
- **Governar pela responsabilidade, não pela repressão.** A regra operativa é "como, com quem e para que se utilizam de semelhantes recursos" (Emmanuel, *Vida e Sexo*, cap. 1). A repressão sem entendimento gera as psiconeuroses descritas por André Luiz; a permissividade sem responsabilidade gera os "saques afetivos" da Lei de Causa e Efeito.
- **Sublimação ≠ negação.** Celibato e abstinência, quando voluntários, são canalização da energia para o serviço — "essa energia simplesmente se canaliza para outros objetivos — os de natureza espiritual" (Emmanuel, *Vida e Sexo*, cap. 23). Quando impostos por inibição irreversível, são prova ou expiação. Em nenhum dos dois casos há "anestesia do sentimento" (idem).
...
- [[wiki/obras/vida-e-sexo]] — fonte primária Emmanuel
- [[wiki/obras/evolucao-em-dois-mundos]] — fonte primária André Luiz (anatomia)
- [[wiki/obras/no-mundo-maior]] — fonte primária André Luiz (peça intermediária 1947, diálogo com a psicanálise)
- [[wiki/conceitos/casa-mental]] — modelo dos três andares mapeado sobre Freud/Adler/Jung
