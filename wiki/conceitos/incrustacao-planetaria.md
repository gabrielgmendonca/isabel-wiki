...
tipo: conceito
fontes: [RE]
tags: [incrustacao-planetaria, jobard, cosmologia, alma-da-terra, metodologia, hipotese-rejeitada, obra/re]
...
3. **Heterogeneidade racial.** Embora Kardec reconheça que "as raças primitivas da Terra provêm de origens diferentes", ele atribui isso a **emigrações espirituais** (raça adâmica como imigração de Espíritos vindos de outro mundo, ver [[wiki/conceitos/raca-adamica]]) e a evoluções locais, não a fusão de planetas físicos.
...
Este conceito — **Espírito diretor de mundo** — é admitido pelo Espiritismo e desenvolvido em [[wiki/obras/genese]] (cap. XI) e em material chicoxaveriano posterior (Emmanuel/[[wiki/personalidades/chico-xavier|Chico Xavier]], *A Caminho da Luz*, Jesus como Espírito diretor da Terra).
...
A formulação entra praticamente intacta em [[wiki/obras/livro-dos-mediuns]] cap. XX ("Influência moral do médium") e cap. XXIV ("Da identidade dos Espíritos"). Em particular, o item 268 de LM (controle universal) é a versão sistematizada da regra de RE abr/1860.
...
- [[wiki/conceitos/discernimento-dos-espiritos]] — método geral do controle do ensino dos Espíritos.
- [[wiki/conceitos/raca-adamica]] — explicação espírita da heterogeneidade racial (imigração de Espíritos, não fusão de planetas).
- [[wiki/conceitos/pluralidade-dos-mundos-habitados]] — moldura cosmológica geral.
- [[wiki/conceitos/lei-natural]] — recusa de teorias que exigiriam derrogação de leis físicas.
