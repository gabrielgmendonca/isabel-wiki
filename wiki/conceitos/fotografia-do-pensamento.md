---
tipo: conceito
fontes: [RE, OPE, Gênese]
tags: [fotografia-do-pensamento, fluidos, pensamento, perispirito, autor/kardec, obra/re, obra/ope, obra/genese, grau/avancado, tema/mediunidade]
...
A primeira menção sistemática do tema na *Revue Spirite* aparece em **junho de 1868** sob o título "Fotografia do Pensamento" ([[wiki/obras/revista-espirita-1868|RE jun/1868]]) — material que será desenvolvido como **ensaio dedicado em [[wiki/obras/obras-postumas|*Obras Póstumas*]]** (1ª parte, ensaio "Fotografia e telegrafia do pensamento", precedido por "Introdução ao estudo da fotografia e da telegrafia do pensamento"). É continuação direta da frente fluídica iniciada em RE 1866 ("Introdução ao estudo dos fluidos espirituais", mar/1866) e sistematizada em [[wiki/obras/genese|*Gênese*]] cap. XIV.

O argumento articula três passos:

1. **O pensamento é uma vibração do perispírito** que age sobre o fluido ambiente — princípio já estabelecido em [[wiki/conceitos/comunhao-de-pensamentos]] (RE dez/1868) e em *Gênese* cap. XIV.
2. **Toda vibração no fluido cósmico deixa impressão** — analogia com a fotografia química (sensibilização da placa pela luz) e com a fonografia (registro do som no cilindro).
3. **A impressão fluídica do pensamento é, em princípio, recuperável** — por mediunidade (fotografia espírita) ou, hipoteticamente, por instrumento físico futuro.
...
- [[wiki/conceitos/fluidos]] — doutrina geral.
- [[wiki/conceitos/perispirito]] — órgão emissor das vibrações fluídicas.
- [[wiki/conceitos/comunhao-de-pensamentos]] — caso coletivo da ação fluídica do pensamento.
- [[wiki/conceitos/maravilhoso-e-sobrenatural]] — recusa do caráter milagroso.
- [[wiki/obras/genese]] — cap. XIV, base doutrinária.
- [[wiki/obras/obras-postumas]] — ensaio dedicado.
...
- Edição local: [[raw/kardec/revista-espirita/1868/06-junho|raw/kardec/revista-espirita/1868/06-junho]]; [[raw/kardec/complementares/obras-postumas-feb/obras-postumas-feb|raw/kardec/complementares/obras-postumas-feb/]].
