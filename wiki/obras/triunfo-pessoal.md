...
3. **TOC com etiologia obsessiva e casos icônicos** — Pôncio Pilatos e Lady Macbeth como casos clínicos, com leitura sistemática das compulsões higiênicas como "assimilação das ondas viciosas" via psicosfera. Articula etiologia psiquiátrica + reencarnatória + obsessiva sem hierarquizá-las (cada caso pode pesar mais em um eixo).
