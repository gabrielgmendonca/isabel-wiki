...
direitos:
  detentor: LEAL
  url_aquisicao: https://www.livrarialeal.com.br/series-e-colecoes/serie-psicologica-joanna-de-angelis/desperte-e-seja-feliz.html
...
Sucessor cronológico direto de [[wiki/obras/autodescobrimento]] (Vol. 6, 1995), *Desperte e Seja Feliz* opera num registro mais **homilético-pastoral** que técnico-psicológico — contrastando deliberadamente com a densidade de *O Ser Consciente* / *Autodescobrimento*. A própria autora espiritual define o propósito no prefácio:
...
Releitura terapêutica de [[wiki/conceitos/planejamento-reencarnatorio]] e da escolha do gênero de prova (LE q. 258ss): a reclamação indevida é esquecimento do compromisso assumido pelo próprio Espírito antes da encarnação.
...
**Cap. 21 — Dor-reparação.** Tipologia tríplice — **dor-elevação, dor-conquista, dor-resgate** — com critério **funcional-pedagógico** (qual é a função da dor no processo evolutivo do espírito), distinto da tipologia de [[wiki/obras/plenitude]] (físicas/morais/emocionais/espirituais — critério de localização ontológica). A dor-resgate é específica: "Existe a dor-elevação, a dor-conquista, a dor-resgate. A tua é resgate, sim, que o teu amor não conseguiu evitar". Convergente, porém não idêntica, à tipologia de André Luiz em *Ação e Reação* cap. 19 (dor-evolução, dor-expiação, dor-auxílio — ver [[wiki/conceitos/dor]]).
...
**Cap. 22 — Amorterapia.** Conceito **explicitamente nomeado e proposto como cunhagem joanniana**: *"Amorterapia — eis a proposta de Jesus."* Já mencionado de passagem em [[wiki/obras/o-ser-consciente]] (cap. 24, "base da amorterapia") e [[wiki/conceitos/leis-morais/lei-de-justica-amor-e-caridade]], aqui é desenvolvido como tese central. Princípio operativo: "Não se apagam incêndios, usando-se combustíveis":
...
- [[wiki/conceitos/amorterapia]] — conceito-título da obra (cap. 22), cunhagem joanniana explícita.
- [[wiki/conceitos/medico-interno]] — sistema autorreparador comandado pela mente (cap. 20).
- [[wiki/conceitos/dor]] — tipologia funcional-pedagógica dor-elevação/dor-conquista/dor-resgate (cap. 21).
- [[wiki/conceitos/depressao]] — um dos três inimigos com terapia pela prece (cap. 7).
- [[wiki/conceitos/jesus-psicoterapeuta]] — Jesus como Modelo Ideal e síntese ânima/ânimus (cap. 1).
- [[wiki/conceitos/planejamento-reencarnatorio]] — programa pré-encarnatório como antídoto à autocompaixão (cap. 6).
- [[wiki/conceitos/provas-e-expiacoes]] — sofrimento como técnica educativa, não punição (cap. 17).
- [[wiki/conceitos/leis-morais/lei-de-justica-amor-e-caridade]] — base doutrinária da amorterapia.
- [[wiki/conceitos/nao-julgar]] — perdão como "esquecimento providencial" e "luarização" da memória (cap. 19), articulado com a abstenção do juízo condenatório.
- [[wiki/conceitos/prece]] — prece como exercício pessoal intransferível (cap. 27).
- [[wiki/conceitos/caridade]] — amor, perdão e serviço como tríade da autorrealização (cap. 18).

## Personalidades citadas

- [[wiki/personalidades/joanna-de-angelis]] — Espírito autor.
- [[wiki/personalidades/divaldo-franco]] — médium psicógrafo.
- [[wiki/personalidades/jesus]] — Modelo Ideal da Humanidade, "Pacificador de todas as vidas".
- [[wiki/personalidades/allan-kardec]] — exemplo de fé raciocinada (cap. 10) e modelo de não-polemizar (cap. 3 — "Allan Kardec, atacado por adversários gratuitos e amigos que não lhe correspondiam à afeição, jamais se defendeu, debateu, polemizou, no campo da vulgaridade").
- [[wiki/personalidades/paulo-de-tarso]] — citado em Hebreus 12:7 (cap. 17).
