...
tipo: questao
fontes: [ESE, LE]
tags: [caridade, salvacao, humildade, egoismo, maximas, obra/ese, obra/le, lei/justica-amor-caridade, autor/kardec, grau/introdutorio]
...
Kardec, dois anos depois da instrução de Paulo, levou a divisa ao próprio Espiritismo: "Fora da caridade não há verdadeiros espíritas" (Kardec, *Viagem Espírita em 1862*). Tornou-se, assim, o critério operativo para reconhecimento entre espíritas de diferentes grupos, países e tendências: a "senha" universal. Ver [[wiki/conceitos/verdadeiro-espirita]].

### Valor prático e de palestra

Para o estudante e o palestrante, a máxima oferece três usos:

1. **Critério de exame próprio** — medir as ações do dia pela vara da caridade ativa (fiz o bem?) antes de medi-las pela vara da ortodoxia doutrinária (cri o correto?).
2. **Critério de discernimento de correntes** — qualquer espiritualismo que aprofunde divisões entre seres humanos contradiz a divisa e, por isso, afasta-se do Espiritismo no essencial, mesmo que use seu vocabulário.
3. **Critério de unidade prática entre espíritas e cristãos** — a divisa permite reconhecer o "verdadeiro cristão" em qualquer denominação que efetivamente pratique a caridade, sem competição sectária (ESE, cap. XV, item 10 final).
