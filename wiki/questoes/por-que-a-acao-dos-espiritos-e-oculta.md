...
tipo: questao
fontes: [LE]
tags: [anjos-guardiaes, espiritos-protetores, livre-arbitrio, progresso, responsabilidade, obra/le]
...
|----------------------------|--------------|
| O homem contaria sempre com ela | Não agiria por si mesmo |
| Sem agir por si mesmo | Não exercitaria as forças próprias |
| Sem exercício | O Espírito não progride |
