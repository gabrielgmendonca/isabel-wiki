...
tipo: personalidade
fontes: [NT]
tags: [estevao, martir, atos, emancipacao-da-alma, grau/intermediario, lei/adoracao]
...
1. **Visão na aproximação da morte — emancipação da alma.**
...
2. **Perdão aos algozes — imitação do Cristo.**
...
3. **"Adormeceu" — vocabulário da imortalidade.**
   O verbo grego *ekoimēthē* ("adormeceu") é o mesmo usado para Lázaro (Jo 11:11–13) e torna-se um dos termos preferidos do NT para a morte do justo (1 Ts 4:13–15). Registra a **continuidade da vida** — a morte como sono do corpo, não extinção do Espírito (LE, q. 149–164).
