...
- [[wiki/personalidades/andre-luiz]] — discípulo durante toda a obra
- [[wiki/personalidades/aniceto]] — orientador paralelo (Centro de Mensageiros, *Os Mensageiros*)
- [[wiki/personalidades/clarencio]] — orientador paralelo (Ministério do Auxílio, *Nosso Lar* e *Entre a Terra e o Céu*)
- [[wiki/conceitos/mediunidade]] — eixo central que orienta
- [[wiki/conceitos/planejamento-reencarnatorio]] — caso Segismundo conduzido por ele
- [[wiki/conceitos/vampirismo-espiritual]] — primeira sistematização chicoxaveriana, formulada nas suas exposições (caps. 3–5)
- [[wiki/conceitos/prece]] — caso Cecília como antídoto operacional (cap. 6)
- [[wiki/conceitos/colonia-espiritual]] — Nosso Lar como contexto institucional
