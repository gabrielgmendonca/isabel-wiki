...
A produção total atribuída a Chico Xavier abrange ainda obras-marco como *Parnaso de Além-Túmulo* e *O Evangelho por Emmanuel* — não ingeridas até a data desta página. O quarteto de **coletâneas evangélicas de Emmanuel** psicografadas por Chico entre 1948 e 1956 — [[wiki/obras/caminho-verdade-e-vida|Caminho, Verdade e Vida]] (1948), [[wiki/obras/pao-nosso|Pão Nosso]] (1950), [[wiki/obras/vinha-de-luz|Vinha de Luz]] (1952) e [[wiki/obras/fonte-viva|Fonte Viva]] (1956) — está **completo na wiki**, fechando o ciclo evangélico do Emmanuel/Chico em registro de comentário pastoral ao versículo.
